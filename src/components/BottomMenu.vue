...
<template>
  <div class="container stage">
    <div class="container">
      <div class="tabbar tab-style2" :class="`${activeItem}-style`">
        <ul class="flex-center">
          <li
            ...
            :class="[
              item.class,
              activeItem === item.name ? item.classActive : '',
            ]"
            :style="item.style"
...
$app-content-background-color: #2a7ec2;
...
.tab-style1 {
  ...
  li {
    ...
    &.follow {
      ...
      width: 60px;
      height: 60px;
      border: 10px solid $app-content-background-color;
      ...
      &:after {
        ...
        top: 27px;
        right: -27px;
        border-top: 11px solid $app-content-background-color;
        background-color: #f9f8fa;
        width: 20px;
        height: 20px;
...
.tab-style4 {
  li {
    ...
    span {
      ...
      text-shadow: inset 2px 2px 4px $clay-box-shadow;
    }
    ...
    &.active:after {
      opacity: 1;
      bottom: 2px;
      text-shadow: inset 2px 2px 8px $clay-box-shadow;
    }
...
.tab-style5 {
  ...
  .active {
    ...
    border-radius: 100%;
    top: -1rem;
    background-color: $clay-background-color;
    box-shadow: 1px 2px 4px 0 $clay-box-shadow, 2px 4px 8px 0 $clay-box-shadow,
      inset 2px 2px 8px $outset-shadow, inset -2px -2px 8px $inset-shadow;
    color: $clay-fg-color;
